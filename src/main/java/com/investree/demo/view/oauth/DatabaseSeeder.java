...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    private String[] roles = new String[]{
            ...
            "ROLE_READ:role:^/.*:GET|PUT|POST|PATCH|DELETE|OPTIONS",
            "ROLE_WRITE:role:^/.*:GET|PUT|POST|PATCH|DELETE|OPTIONS"
    };
    ...
    public void insertUser(String password) {
        for (String userNames: users) {
            ...
            Users oldUser = usersRepository.findOneByUsername(username);
            if (null == oldUser) {
                oldUser = new Users();
